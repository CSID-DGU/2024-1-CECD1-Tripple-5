package com.example.traveltalk.data.datasource.local

import android.content.Context
import androidx.core.content.edit
import androidx.security.crypto.EncryptedSharedPreferences
import androidx.security.crypto.MasterKey
import com.example.traveltalk.BuildConfig
...
@Singleton
class TravelTalkStorageImpl @Inject constructor(@ApplicationContext context: Context) :
    TravelTalkStorage {
