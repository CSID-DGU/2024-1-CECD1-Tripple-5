...
# 특정 채팅방 조회 엔드포인트
@router.get("/chat_rooms/{chat_room_id}", response_model=chat_room_dto.ChatRoomDetailResponse)
...
@router.get("/users/{user_id}/chat_rooms/", response_model=chat_room_dto.ChatRoomsDetailResponse)
