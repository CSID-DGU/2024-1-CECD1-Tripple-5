...
# 특정 추천 기록 조회 엔드포인트
@router.get("/recommendation_records/{record_id}", response_model=recommendation_record_dto.RecommendationRecord)
...
@router.get("/users/{user_id}/recommendation_records/", response_model=recommendation_record_dto.RecommendationRecordsResponse)
